...
var FormComponent = /** @class */ (function () {
    function FormComponent(builder, logisticService, toastService, route, router, http, loadingController, navCtrl, camera, file) {
    ...
    FormComponent.prototype.ionViewWillEnter = function () {
        ...
        if (this.route.snapshot.data.formType === 'EDIT') {
            ...
            this.logisticService.getProfile().subscribe(function (data) {
                ...
                _this.imageSrc = src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["environment"].url + data.data.delivery_pic;
