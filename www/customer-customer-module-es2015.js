...
let CartmodalComponent = class CartmodalComponent {
    constructor(productService, customerService, toastService, event, modalController, alertController) {
...
module.exports = ".ios ion-footer .toolbar:last-child {\n  padding-bottom: calc(constant(safe-area-inset-bottom) + 4px);\n  padding-bottom: calc(env(safe-area-inset-bottom) + 4px);\n  min-height: calc(44px + constant(safe-area-inset-bottom));\n  min-height: calc(44px + env(safe-area-inset-bottom)); }\n\n.rating-container .ion-button {\n  --padding-start: 4px;\n  --padding-end: 4px; }\n\n.rating-container .ion-button ion-icon {\n    color: gray; }\n\n.rating-container .ion-button ion-icon[ng-reflect-name=\"star\"] {\n    color: #ffb400; }\n\n.footer-center {\n  display: block;\n  margin-left: auto;\n  margin-right: auto; }\n\nion-card, card-ios, card-md {\n  margin-top: 4px  !important;\n  margin-bottom: 4px !important; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
let MapmodalComponent = class MapmodalComponent {
    constructor(_modalCtrl, _geolocation, _loading, toastService) {
