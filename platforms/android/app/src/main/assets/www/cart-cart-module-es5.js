...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-buttons slot=\"start\">\n      <ion-menu-button></ion-menu-button>\n    </ion-buttons>\n    <ion-title>รับชำระเงิน</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n <!--  <app-price\n    [price]=\"price\">\n  </app-price>  --> \n\n<ion-item-divider style=\"background:#f2f2f2;\">\n  <div slot=\"start\">\n    <h3>ราคารวม</h3>\n  </div>\n  <div slot=\"end\">\n    <h2>{{ price | number }} ฿</h2>\n  </div>\n</ion-item-divider> \n\n\n  <app-list \n    [cart]=\"cart\" \n    (removeFromCartChange)=\"removeFromCart($event)\" \n    (addItemChange)=\"addItem($event)\">\n  </app-list>\n   <div #mapElement ></div>\n\n\n</ion-content>\n\n<ion-footer style=\"background:#FFFFFF;\">\n  <ion-row >\n\n <!--   <ion-item>\n        <ion-label position=\"floating\">รหัสสินค้า</ion-label>\n        <ion-input type=\"text\" name=\"code_product\"  ></ion-input>\n        <ion-button slot=\"end\" size=\"small\" color=\"success\" *ngIf=\"scan\" (click)=\"letScan()\">สแกน</ion-button>     (click)=\"letScan() \"   \n      </ion-item> -->\n\n\n <ion-col size=\"12\" *ngIf=\"usertype == 3\">\n    <ion-button expand=\"block\" (click)=\"store_customers(store_id)\" color=\"success\">\n      <ion-icon slot=\"end\" name=\"add\"></ion-icon>\n      ซื้อสินค้าเพิ่ม \n    </ion-button>\n  </ion-col>\n\n\n  <ion-col size=\"12\" *ngIf=\"usertype == 1\" >\n\n     <!-- <ion-item > -->\n        <!-- <ion-label position=\"floating\">รหัสสินค้า</ion-label> -->\n        <!-- <ion-input type=\"text\" name=\"code_product\" (ionFocus)=\"letScan()\"></ion-input> -->\n        <!-- <ion-button slot=\"end\" size=\"small\" color=\"success\" *ngIf=\"scan\" (click)=\"letScan()\">สแกน</ion-button>         -->\n      <!-- </ion-item> -->\n\n\n     <ion-searchbar placeholder=\"รหัสสินค้า\" color=\"primary\" animated debounce=\"500\" (ionChange)=\"search($event.target.value)\">\n  </ion-searchbar>\n\n\n\n\n   <!--  <ion-button expand=\"block\" color=\"secondary\" (ionFocus)=\"letScan()\" >\n      <ion-icon slot=\"end\" name=\"qr-scanner\"></ion-icon>\n      สแกนสินค้า\n    </ion-button> -->\n  </ion-col>  \n\n <!--  <ion-col size=\"12\" *ngIf=\"usertype == 1\" >\n    <ion-button expand=\"block\" color=\"secondary\" (ionFocus)=\"scan()\" >\n      <ion-icon slot=\"end\" name=\"qr-scanner\"></ion-icon>\n      สแกนสินค้า2\n    </ion-button>\n  </ion-col>   -->\n\n</ion-row>\n\n <!-- <ion-item (click)=\"store_product(store_distances.id)\"> -->\n  <ion-button expand=\"full\" color=\"primary\" (click)=\"newTransaction()\">\n  {{ usertype == 1 ? 'รับชำระเงินด้วย QR Code' : 'ชำระเงินด้วย QR Code' }}</ion-button>\n  \n</ion-footer>\n\n\n\n\n"
...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-buttons slot=\"start\">\n      <ion-menu-button></ion-menu-button>\n    </ion-buttons>    \n    <ion-title>ชำระเงินด้วยQR</ion-title>\n    <ion-buttons slot=\"end\">\n      <ion-back-button></ion-back-button>\n    </ion-buttons>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content class=\"app-background\">\n  <div #mapElement ></div>\n  <ion-card style=\"background:#FFFFFF;\">\n    <qrcode [qrdata]=\"qr.promptpay\" [size]=\"256\" [level]=\"'M'\"></qrcode>\n    <ion-card-content>\n      <ion-list>\n          <ion-label><h2><b>รายการสินค้า</b></h2></ion-label>\n        <ion-item *ngFor=\"let item of qr.items\">\n           <div slot=\"start\">\n          <h3> {{ item.product_th }}</h3>\n        </div>\n        <div slot=\"end\">\n          <ion-badge> \n          <h3>{{ item.price | number}}$</h3>\n        </ion-badge> \n        </div>\n        </ion-item> \n      </ion-list>\n      <ion-item-divider>\n        <div slot=\"start\">\n          <h3>ราคารวม</h3>\n        </div>\n        <div slot=\"end\">\n          <ion-badge color=\"danger\">\n          <h3>{{ qr.price | number }}$</h3>\n        </ion-badge>\n        </div>\n      </ion-item-divider>\n\n      <!--  <ion-item-divider>\n        <div slot=\"start\">\n          <h3>{{latitude }}</h3>\n        </div>\n        <div slot=\"end\">\n          <h2>{{longitude }}</h2>\n        </div>\n      </ion-item-divider> -->\n\n    </ion-card-content>\n  </ion-card>\n\n<!-- <form [formGroup]=\"profileForm\">\n        <ion-item>\n          <ion-input  type=\"text\" formControlName=\"latitude\">ferfref</ion-input>\n            <ion-input  type=\"text\" formControlName=\"longitude\">fefr</ion-input>\n        </ion-item> \n      \n  </form>\n -->\n\n\n</ion-content>\n\n<ion-footer>\n  <ion-row>\n    <ion-col size=\"12\">\n      <ion-button expand=\"full\" color=\"primary\" type=\"submit\"  (click)=\"verifyTransaction(id)\">เสร็จสิ้น</ion-button>\n    </ion-col>\n<!--     <ion-col size=\"6\">\n      <ion-button expand=\"full\" color=\"danger\"  (click)=\"closeModal(0)\">ยกเลิก</ion-button>\n    </ion-col> -->\n  </ion-row>  \n</ion-footer>"
...
module.exports = ".app-background {\n  --background: url(\"/assets/bg1.jpg\") 0 0/100% 100% no-repeat;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var CartPage = /** @class */ (function () {
    function CartPage(cartService, transactionService, productService, toastService, alertService, qrService, modalController, http, router, route, geolocation, barcodeScanner, builder) {
        var _this = this;
        ...
        this.price = 0;
        this.store_id = 0;
        this.productService.getAll().subscribe(function (resp) {
            _this.product_all = resp.products.data;
            console.log('product_all', _this.product_all);
        });
    ...
    CartPage.prototype.ngAfterViewInit = function () {
        var _this = this;
            ...
            buttons: [
                {
                    ...
                    handler: function () {
                        if (_this.store_id) {
                            _this.transactionService.newTransaction(_this.cart, _this.price, _this.latitude, _this.longitude, _this.firstname, _this.lastname, _this.mobile_number, _this.latitude_store, _this.longitude_store, _this.store_id, _this.promptpay, _this.verified = 0).subscribe(function (trn) {
                                console.log(trn);
                                _this.toastService.showToast('ยกเลิกการซื้อสินค้าแล้ว', 'top');
                            });
                        }
                        else {
                            _this.transactionService.newTransactionStore(_this.cart, _this.price, _this.verified = 0).subscribe(function (trn) {
                                _this.toastService.showToast('ยกเลิกการซื้อสินค้าแล้ว', 'top');
                            });
                        }
                    },
                ...
                },
                {
                    ...
                    handler: function () {
                        if (_this.store_id) {
                            _this.cartService.getStorePromptpay(_this.store_id).subscribe(function (res) {
                                _this.promptpay = res.data[0].promptpay;
                                console.log(res);
                                console.log(_this.promptpay);
                                _this.cartService.getStoreMaps(_this.store_id).subscribe(function (res) {
                                    _this.latitude_store = res.data[0].latitude;
                                    _this.longitude_store = res.data[0].longitude;
                                    console.log('store_map', _this.latitude_store, _this.longitude_store);
                                    _this.transactionService.getUser().subscribe(function (res) {
                                        _this.firstname = res.data.firstname;
                                        _this.lastname = res.data.lastname;
                                        _this.mobile_number = res.data.mobile_number;
                                        _this.store_id;
                                        _this.transactionService.newTransaction(_this.cart, _this.price, _this.latitude, _this.longitude, _this.firstname, _this.lastname, _this.mobile_number, _this.latitude_store, _this.longitude_store, _this.store_id, _this.promptpay, _this.verified = 1).subscribe(function (trn) {
                                            console.log('user_map', _this.latitude, _this.longitude);
                                            _this.qrService.generatePromptPayQRs(trn.data).subscribe(function (qr) {
                            ...
                            _this.transactionService.newTransactionStore(_this.cart, _this.price, _this.verified = 1).subscribe(function (trn) {
                                console.log(_this.cart, _this.price, _this.verified);
                                _this.qrService.generatePromptPayQRs(trn.data).subscribe(function (qr) {
                                    _this.QRModal(qr, trn);
                                    // console.log(33);
                                    // console.log(qr);
    ...
    CartPage.prototype.addItem = function (product) {
    ...
    // test
    CartPage.prototype.search = function (product_code) {
        var _this = this;
        this.productService.getAll().subscribe(function (resp) {
            _this.product_all = resp.products.data;
            console.log('product_all', _this.product_all);
    ...
    //    });
    //  }
    CartPage.prototype.getProduc = function () {
        var _this = this;
        this.productService.getAll().subscribe(function (resp) {
            _this.product_all = resp.products.data;
            console.log('product_all', _this.product_all);
    ...
    CartPage.prototype.store_customers = function (store_id) {
...
module.exports = "ion-button {\n  --padding-start: 0;\n  --padding-end: 0;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ListComponent = /** @class */ (function () {
    function ListComponent(route, router, http) {
        this.route = route;
        this.router = router;
        this.http = http;
    ...
    ListComponent.prototype.addItem = function (product) {
...
module.exports = "ion-item-divider {\n  --padding-top: 10px;\n  --padding-bottom: 10px;\n}\n\nion-badge {\n  --padding-top: 10px;\n  --padding-bottom: 10px;\n  --padding-start: 30px;\n  --padding-end: 30px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".app-background {\n  --background: url(\"/assets/bg1.jpg\") 0 0/100% 100% no-repeat;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var QrmodalComponent = /** @class */ (function () {
    function QrmodalComponent(transactionService, modalController, router, alertService, geolocation, route, builder, toastService, loadingController, navCtrl, http, cartService) {
        var _this = this;
        this.transactionService = transactionService;
        this.modalController = modalController;
        this.router = router;
    ...
    // ionViewWillEnter() {
    // }
    QrmodalComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.geolocation.getCurrentPosition().then(function (resp) {
            console.log(resp);
            _this.latitude = resp.coords.latitude;
    ...
    // latitude , longitude
    QrmodalComponent.prototype.verifyTransaction = function (longitude, latitude, latitude_store, longitude_store, store_id) {
        var _this = this;
        if (this.store_id) {
            this.cartService.getStorePromptpay(this.store_id).subscribe(function (res) {
                _this.promptpay = res.data[0].promptpay;
                console.log(res);
                console.log(_this.promptpay);
                _this.transactionService.getUser().subscribe(function (res) {
                    ...
                    _this.lastname = res.data.lastname;
                    _this.mobile_number = res.data.mobile_number;
                    _this.transaction.latitude = _this.latitude;
                    _this.transaction.longitude = _this.longitude;
                    _this.transaction.firstname = _this.firstname;
                    _this.transaction.lastname = _this.lastname;
                    _this.transaction.mobile_number = _this.mobile_number;
                    _this.transaction.latitude_store = _this.latitude_store;
                    _this.transaction.longitude_store = _this.longitude_store;
                    _this.transaction.promptpay = _this.promptpay;
                    _this.transaction.store_id = _this.store_id;
                    _this.transactionService.verifyTransaction(_this.transaction).subscribe(function (res) {
                        _this.closeModal(1);
                        console.log(_this.transaction);
                    });
                });
            });
            this.cartService.getStoreMaps(this.store_id).subscribe(function (res) {
                _this.latitude_store = res.data[0].latitude;
                _this.longitude_store = res.data[0].longitude;
                console.log('store_map', _this.latitude_store, _this.longitude_store);
            });
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        ...
                        //  });
                        _this.transactionService.orderProducts().subscribe(function (res) {
                            console.log(res);
                            _this.code_randoms = res.data.code_randoms;
                            console.log(_this.code_randoms);
                            _this.store_id = res.data.store_id;
                            console.log(_this.store_id);
                            _this.transactionService.getUser().subscribe(function (res) {
                                _this.firstname = res.data.firstname;
                                _this.lastname = res.data.lastname;
                                _this.mobile_number = res.data.mobile_number;
                                _this.transactionService.newTransactionOrder(_this.firstname, _this.lastname, _this.mobile_number, _this.store_id, _this.code_randoms).subscribe(function (trn) {
                                });
                            });
                        });
                    }
    ...
    QrmodalComponent.ctorParameters = function () { return [
