...
module.exports = "<ion-app>\n  <ion-split-pane>\n    <ion-menu>\n      <ion-header>\n        <ion-toolbar>\n          <ion-title>เมนู</ion-title>\n        </ion-toolbar>\n      </ion-header>\n      <ion-content>\n\n        <ion-list>\n          <ion-menu-toggle auto-hide=\"false\" >\n            <ion-item *ngIf=\"usertype == 1\" (click)=\"home()\">\n              <ion-label>\n                   หน้าแรก\n              </ion-label>\n            </ion-item>\n            <ion-item *ngIf=\"usertype == 1\" (click)=\"product()\">\n              <ion-label>\n                   สินค้า\n              </ion-label>\n            </ion-item>\n             <ion-item *ngIf=\"usertype == 1\" (click)=\"postproduct()\">\n              <ion-label >\n                   นำเข้าสินค้า\n              </ion-label>\n            </ion-item>\n            <!-- <ion-item *ngIf=\"usertype == 3\" (click)=\"postproductimg()\">\n              <ion-label >\n                   สั่งสินค้า\n              </ion-label>\n            </ion-item> -->\n            <ion-item *ngIf=\"usertype == 1\" (click)=\"store()\">\n              <ion-label >\n                   ข้อมูลร้าน\n              </ion-label>\n            </ion-item>\n            <ion-item *ngIf=\"usertype == 2\" (click)=\"logistic()\">\n              <ion-label >\n                   ขนส่งสินค้า\n              </ion-label>\n            </ion-item >\n            <ion-item *ngIf=\"usertype == 3\" (click)=\"customer()\">\n              <ion-label>\n                   สั่งสินค้าจากร้าน\n              </ion-label>\n            </ion-item>\n             <ion-item  *ngIf=\"usertype == 1\" (click)=\"stats()\">\n              <ion-label>\n                   สถิติ\n              </ion-label>\n            </ion-item>\n            <ion-item *ngIf=\"usertype == 1\" (click)=\"sell()\">\n              <ion-label >\n                   สรุปการขาย\n              </ion-label>\n            </ion-item>\n           <!-- <ion-item *ngIf=\"usertype == 1\" (click)=\"delivery()\">\n              <ion-label >\n                   เรียกคนส่งของ\n              </ion-label>\n            </ion-item> -->\n            <ion-item *ngIf=\"usertype == 1\" (click)=\"order()\">\n              <ion-label >\n                   ออเดอร์สินค้า\n              </ion-label>\n            </ion-item>\n            <ion-item (click)=\"logout()\">\n              <ion-label >\n                   ออกจากระบบ\n              </ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n        </ion-list>\n      </ion-content>\n    </ion-menu>\n    <ion-router-outlet main></ion-router-outlet>\n  </ion-split-pane>\n</ion-app>\n\n<!-- <ion-app>\n  <ion-split-pane>\n    <ion-menu>\n      <ion-header>\n        <ion-toolbar>\n          <ion-title>Menu</ion-title>\n        </ion-toolbar>\n      </ion-header>\n      <ion-content>\n        <ion-list>\n          <ion-menu-toggle auto-hide=\"false\" *ngFor=\"let p of appPages\">\n            <ion-item [routerDirection]=\"'root'\" [routerLink]=\"[p.url]\">\n              <ion-icon slot=\"start\" [name]=\"p.icon\"></ion-icon>\n              <ion-label>\n                {{p.title}}\n              </ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n        </ion-list>\n      </ion-content> \n    </ion-menu>\n    <ion-router-outlet main></ion-router-outlet>\n  </ion-split-pane> \n</ion-app>\n -->"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, event, router) {
        ...
        this.event.subscribe('user:changed', function (type) {
            _this.usertype = type;
        });
