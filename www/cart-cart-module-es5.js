...
var CartPage = /** @class */ (function () {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (status) {
                            ...
                            if (status.data == 2) {
                                ...
                                setTimeout(function () {
                                    _this.cartService.getOrders(_this.store.id).subscribe(function (data) {
                                        console.log(data);
                                        data.forEach(function (e) {
                                            e.orders.forEach(function (oo) {
    ...
    CartPage.prototype.cancelRequest = function (id) {
        this.cartService.cancelRequest(id).subscribe(function (data) {
            console.log(data);
        });
    };
...
var DvrmodalComponent = /** @class */ (function () {
    ...
    DvrmodalComponent.prototype.callRider = function () {
        var _this = this;
